# Databricks notebook source exported at Sun, 11 Sep 2016 12:27:03 UTC
# MAGIC %md
...
# TODO: Replace <FILL IN> with appropriate code
pluralRDD = wordsRDD.map(lambda x: x+'s')
...
totalCount = (wordCounts
              .map(lambda (x,y): y) #RDD of Values
...
def removePunctuation(text):
    ...
    """
    string = re.sub(r"[^A-Za-z\s\d]+", "", text)
